        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Job Title 1</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Job Title 1</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('job-title.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="job-title-table">
                            <thead>
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data_job_title = $('#job-title-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('job-title.getData') }}",
                    dataType: "JSON",
                    type: "GET",
                    data:function(d){
                        // d.status = getStatus();
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function() {
                                ...
                                data_job_title.ajax.reload(null, false);
                            }
                        });
