            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item show menu-accordion">
                    <span class="menu-link">
                        ...
                        <a href="{{route('job-title')}}" class="menu-title">Job Title</a>
                    </span>
                </div>
                <div class="menu-item show menu-accordion">
                    <span class="menu-link">
                        ...
                        <a href="{{route('respon')}}" class="menu-title">Respon</a>
                    </span>
                </div>
                <div class="menu-item show menu-accordion">
                    <span class="menu-link">
                        ...
                        <a href="{{route('menu')}}" class="menu-title">Menu</a>
                    </span>
                </div>
                ...
                <div class="menu-item show menu-accordion">
                    <span class="menu-link">
                        ...
                        <a href="{{route('status-project-selling')}}" class="menu-title">Status Project Selling</a>
                    </span>
                </div>
