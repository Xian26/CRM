        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Status Project Selling</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Status Project Selling</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar">
                            <a href="{{ route('status-project-selling.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="status-project-selling-table">
                            <thead>
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data_status_project_selling = $('#status-project-selling-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('status-project-selling.getData') }}",
                    dataType: "JSON",
                    type: "GET",
                    data:function(d){
                        // d.status = getStatus();
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('status-project-selling.delete') }}",
                            data: ({
                                "_token": "{{ csrf_token() }}",
                                "_method": 'DELETE',
                                ix: ix,
