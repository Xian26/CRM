                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Nama</label>
                                        <input type="text" name="name" class="form-control mb-2" placeholder="Nama" value="{{$data->name}}" />
                                ...
                                <div class="mb-10 fv-row">
                                    <label class="required form-label">No Telepon</label>
                                        <input type="number" name="no_telepon" class="form-control mb-2" placeholder="No Telepon" value="{{$data->no_telepon}}" />
                                    <div class="text-muted fs-7"></div>
                                </div>

                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Contact</label>
                                        <input type="text" name="contact" class="form-control mb-2" placeholder="Contact" value="{{$data->contact}}" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Alamat</label>
                                        <textarea name="alamat" class="form-control" cols="20" rows="5">{{$data->alamat}}</textarea>
                                    <div class="text-muted fs-7"></div>
                                </div>

                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Info Lainnya</label>
                                        <textarea name="info_lainnya" class="form-control" cols="20" rows="5">{{$data->info_lainnya}}</textarea>
                                    <div class="text-muted fs-7"></div>
                                </div>
                            </div>
                        </div>
